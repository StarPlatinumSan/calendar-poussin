...
const IS_LOCAL_PRODUCTION =
  IS_PRODUCTION &&
  (LOCAL_HOST_PATTERN.test(CLIENT_ORIGIN) ||
    LOCAL_HOST_PATTERN.test(GOOGLE_CALLBACK_URL))
...
app.put('/api/events/:id', requireAuth, async (req, res) => {
  const event = await sharedCalendarEventsRepository.updateEvent(
    req.params.id,
    req.body || {}
  )
